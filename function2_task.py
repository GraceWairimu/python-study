...
def largest(num1,num2,num3,num4):
   ...
   if num1>num2 and num1>num3 and num1>num4:
      valid=(f"{num1} is the largest")
   elif num2>num1 and num2>num3 and num2>num4:
      valid=(f"{num2} is the largest")
   elif num3>num1 and num3>num2 and num3>num4:
      valid=(f"{num3} is the largest")
   else:
      valid=(f"{num4} is the largest")
...
def check():
   ...
   for i in range(tries):
     ...
     if email==correct_email and password==correct_password:
          ...
          rem_tries=tries-(i+1)
          val=f"Invalid username or password.You only have {rem_tries} left"

          if rem_tries==0:
            val="The account has been blocked"
          else:
             continue
